...
#
#         Project: lcls-plc-bergmann-kohzu.tsproj
#        PLC name: lcls_plc_bergmann_kohzu (lcls_plc_bergmann_kohzu Instance)
...
epicsEnvSet("IPADDR",           "172.21.68.129")
epicsEnvSet("AMSID",            "172.21.68.129.1.1")
epicsEnvSet("AMS_PORT",         "851")
epicsEnvSet("ADS_MAX_PARAMS",   "1407")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.68.129 ^172.*$")
...
epicsEnvSet("PREFIX",         "PLC:lcls_plc_bergmann_kohzu:")
...
epicsEnvSet("MOTOR_PREFIX",    "CXI:BERGMANN:MMS:")
epicsEnvSet("MOTOR_NAME",      "XTAL1_TH")
epicsEnvSet("DESC",            "Main.M4 / XTAL1_TH")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "CXI:BERGMANN:MMS:")
epicsEnvSet("MOTOR_NAME",      "XTAL3_CHI")
epicsEnvSet("DESC",            "Main.M7 / XTAL3_CHI")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "CXI:BERGMANN:MMS:")
epicsEnvSet("MOTOR_NAME",      "XTAL3_TH")
epicsEnvSet("DESC",            "Main.M8 / XTAL3_TH")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:lcls_plc_bergmann_kohzu")
dbLoadRecords("save_restoreStatus.db", "P=PLC:lcls_plc_bergmann_kohzu:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls_plc_bergmann_kohzu,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:lcls_plc_bergmann_kohzu")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:lcls_plc_bergmann_kohzu,PROJECT=lcls-plc-bergmann-kohzu.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.68.129")

#   lcls-twincat-motion: * -> 4.1.1 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_bergmann_kohzu,DEPENDENCY=lcls-twincat-motion,VERSION=4.1.1,VENDOR=SLAC")
#   Tc2_Standard: * -> 3.3.3.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_bergmann_kohzu,DEPENDENCY=Tc2_Standard,VERSION=3.3.3.0,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * -> 3.4.26.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_bergmann_kohzu,DEPENDENCY=Tc2_System,VERSION=3.4.26.0,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * -> 3.3.21.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_bergmann_kohzu,DEPENDENCY=Tc3_Module,VERSION=3.3.21.0,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("lcls_plc_bergmann_kohzu.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls_plc_bergmann_kohzu:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 407
callbackSetQueueSize(2814)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:lcls_plc_bergmann_kohzu:")
